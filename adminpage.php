...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="show_clock()">
	...
	$query = "SELECT username from ctb_admin  WHERE username='".mysql_escape_string ($unameku)."' and pass=md5('".mysql_escape_string ($password)."')";
	echo $query;
...
<script language="javascript" src="scripts/tanggal.js">
	...
	<tr>
		<td colspan="11" rowspan="6" valign="top" bgcolor="#111A1F"><div align="center">
		  ...
		  <p align="justify" class="style26">Selamat datang di Admin Page.</p>
		  <p class="style2">&nbsp; </p>
		<?

...
<?php if (!isset($_POST['submitBtn3'])) { ?>      
      ...
      <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="poll">
        ...
        ?>
          <tr><td align="center"><br/><input class="text" type="submit" name="submitBtn3" value="Vote" /></td></tr>
        </table>  
      </form>
<?php    
} else {
